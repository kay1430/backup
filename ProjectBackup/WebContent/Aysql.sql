...
CREATE TABLE THEATER(
	...
	TH_S_DATE DATE NOT NULL,
	TH_E_DATE DATE NOT NULL
)
...
INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '명동', 1, '1관', 1, 90, to_date('12:30:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '명동', 1, '1관', 2, 90, to_date('1:00:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '명동', 1, '3관', 1, 90, to_date('17:30:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));


INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '명동', 2, '2관', 1, 90, to_date('13:00:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '대학로', 4, '1관', 1, 90, to_date('15:00:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '신촌', 3, '1관', 1, 90, to_date('10:00:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '강남', 1, '1관', 1, 90, to_date('20:00:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '강남', 4, '1관', 1, 90, to_date('12:30:00','HH24:MI:SS'), to_date('2016-08-03','YYYY-MM-DD'), to_date('2016-08-06','YYYY-MM-DD'));

--상영끝난DATA
INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '건대', 1, '1관', 1, 90, to_date('12:30:00','HH24:MI:SS'), to_date('2016-08-02','YYYY-MM-DD'), to_date('2016-08-03','YYYY-MM-DD'));
--th_s_date < sysdate < th_sdate < sysdate+2 인 data
INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '종로', 1, '1관', 1, 90, to_date('16:30:00','HH24:MI:SS'), to_date('2016-08-02','YYYY-MM-DD'), to_date('2016-08-05','YYYY-MM-DD'));
--8/5 발표를 위한 data: 1: (th_s_date = 8/3, th_e_date = 8/6), 2: (th_s_date = 8/3, th_e_date = 8/7) , 3: (th_time < 발표시간), 4: (th_time < 발표시간)
INSERT INTO THEATER
VALUES(TH_SEQ.NEXTVAL, '종로', 1, '2관', 1, 90, to_date('18:30:00','HH24:MI:SS'), to_date('2016-08-02','YYYY-MM-DD'), to_date('2016-08-07','YYYY-MM-DD'));


SELECT * FROM THEATER WHERE MV_SEQ=1 AND SYSDATE>=TH_S_DATE AND SYSDATE<=TH_E_DATE ORDER BY MV_SEQ
...
SELECT S_NAME 
FROM SEAT 
WHERE TH_SEQ=1 AND S_CHECK=0 AND S_DATE=TO_DATE('2016-08-03', 'YYYY-MM-DD')
...
--
DELETE RESERVATION WHERE R_SEQ=8;
