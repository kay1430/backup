...
public class ReservationDTO {
	...
	private int r_elder;
	private String r_seat;//////////////////좌석정보
	private Timestamp r_time; //예약한 날짜
	private Timestamp r_viewtime; //볼 날짜
	...
	public String toString() {
		return "ReservationDTO [r_seq=" + r_seq + ", m_id=" + m_id + ", th_seq=" + th_seq + ", mv_seq=" + mv_seq
				...
				+ r_student + ", r_elder=" + r_elder + ", r_seat=" + r_seat + ", r_time=" + r_time + ", r_viewtime="
				+ r_viewtime + ", r_thname=" + r_thname + ", r_cinema=" + r_cinema + "]";
	}
