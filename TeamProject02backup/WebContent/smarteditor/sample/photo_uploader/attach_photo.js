    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/TeamProject02ver0.1/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/TeamProject02ver0.1/file_uploader_html.jsp',	//샘플 URL입니다.
 	        sCallback : '/TeamProject02ver0.1/smarteditor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	    	sFiletype : "*.jpg;*.png;*.bmp;*.gif;*.jpeg",						//허용할 파일의 형식. ex) "*", "*.*", "*.jpg", 구분자(;)	
